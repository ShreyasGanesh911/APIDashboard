    ...
    <>
      <form className=' px-14  bg-neutral-900 rounded-2xl w-3/4 h-4/5  flex flex-col justify-center'>
              ...
              <div className='flex justify-center items-start flex-col mt-3'>
               <div>
               <label htmlFor="password" className='  tracking-wide text-lg text-white ' >Password:</label>
               </div>
                <div className='w-3/4 flex items-center'>
                <input className='border border-slate-400 w-full p-3 my-3 rounded outline-slate-400 tracking-wide text-black ' placeholder='Enter Password' type={show} />
